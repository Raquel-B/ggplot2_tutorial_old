...
- but uou can also change the distance by specifying the margin of both text elements:
...
The _face_ argument can be used to make the font `bold` or `italic` or even `bold.italic`.
